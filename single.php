...
<div class="container">
    <div class="content row">
        ...
        <div class="main-content col-md-9 col-12">
            <h2>As a fresh perspective on the genre of hunting games, WILD HEARTS™ suggests that you use the science of
                the past to win against giant creatures that have absorbed the forces of nature.</h2>
            <div class="single_post row">
                <div class="img col-12">
                    <img src="assets/images/fb9fe7JhjCL5vOsWY3wpSOm8.png" alt="" class="img-thumbnail">
                </div>
                <div class="info">
                    <i class="bi bi-person">Adventure</i>
                    <i class="bi bi-calendar">Release: 2/17/2023</i>
                </div>
